    ...
    <div className="min-h-[100dvh] flex flex-col items-center justify-center bg-background p-6">
      <div className="w-full max-w-lg space-y-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-semibold tracking-tight text-foreground">Pre-Adjudication Integrity Protocol</h1>
            <p className="text-xs text-muted-foreground mt-0.5">Select how you are participating in this program.</p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground mt-1">
              I supervise participant activity and generate participation summaries for program monitoring purposes.
            </p>
          </button>
        </div>

        <p className="text-xs text-muted-foreground text-center">
          Your role determines what you can access. If you selected incorrectly, contact your program coordinator.
        </p>
      </div>
    </div>
  );
